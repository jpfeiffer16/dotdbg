// Credit goes to blessed-contrib: https://www.npmjs.com/package/blessed-contrib#tree
...
function Tree(options) {
  ...
  this.rows.on('select', function (item) {
  ...
  if (node.children && node.extended) {
    ...
    for (var child in node.childrenContent) {
      ...
      if (typeof child.children === 'function')
        ...
        child.children(node, result => {
          child.childrenContent = result;
        });
      else
